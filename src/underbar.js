(function() {
  ...
  // last element.
  _.last = function(array, n) { //[1,2,3,4,5,6,7] n-2 --> [[6,7]] (index 5,6)
    if (n > array.length) {
      return array;
    }
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(allPass, item) {
      if (!allPass) {
       ...
       //!! turns into strict true, (vs truthy value)
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      //check if storage contains arguments
      if(!storage[args]) {
